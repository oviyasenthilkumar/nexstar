...
//             "
//           >
//             <p className="text-white/80 text-[10px] sm:text-sm md:text-base lg:text-lg leading-relaxed font-sora mb-4 sm:mb-6 md:mb-8 max-w-[95vw] ">
...
//               <a
//                 href="#ebook"
//                 className="relative bg-white/10 border border-white/20 text-white text-xs sm:text-sm md:text-base px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-full font-semibold flex items-center gap-2 hover:bg-white/20 transition duration-150 hover:scale-105"
//               >
//                 <span className="absolute -top-[25%] left-3 bg-[#A71414] text-white text-[10px] sm:text-xs md:text-sm px-2 py-1 rounded-full">
//                   The New ONE is Us
//                 </span>
...
export default function Home() {
  return (
    <div
      className="relative text-white bg-cover bg-center h-[110vh] md:h-[103vh] lg:h-[130vh] xl:h-[150vh] 2xl:h-[140vh]"
      style={{ backgroundImage: "url('/images/Solution.png')" }}
    >
      {/* Layered Curve Background */}
      <div
