    ...
    >
      ...
      />
        ...
        <div className="relative mb-2 md:mb-0 py-0 sm:py-12 md:py-0 pt-30 sm:pt-8 md:pt-0 ">
          ...
          <div className="absolute top-150 sm:top-40 md:top-145 lg:top-115 2xl:top-114 left-1/2 transform -translate-x-1/2 flex flex-col sm:flex-row justify-center items-center gap-7 sm:gap-6 md:gap-8 px-4 z-20 w-full max-w-xs sm:max-w-none">
            <a
              href="/ebook/book.pdf"
              target="_blank"
              rel="noopener noreferrer"
